...
OVERALL_FUNCTION = args['function']
...
def main():
    #print('yay')
    left, right = most_recent_file('left'), most_recent_file('right')
    left, right = csv_to_list(left), csv_to_list(right)
    ...
    while len(left) > 0 or len(right) > 0:
        ...
        output.write(f'  {MARBLE_FUNCTION}({timestamp}, {left_pan}, {left_tilt}, {right_pan}, {right_tilt});\n\n')
