...
class draw_scene:
    def __init__(self,style=1):
        ...
        self.model1.load_stl('assets/MarbleHeadset.stl')          # os.path.abspath('')+'/binary.stl'
        self.init_shading()
    ...
    def resize(self, dimensions):
        ...
        glLoadIdentity()
        gluPerspective(45, 1.0*dimensions[0]/dimensions[1], 0.1, 100.0)
...
def main():
    ...
    #glLightfv(GL_LIGHT0, GL_SPECULAR, (-40, 200, 100, 0.0))
    glEnable(GL_LIGHT0)
    glEnable(GL_LIGHTING)
    glEnable(GL_COLOR_MATERIAL)
    glEnable(GL_DEPTH_TEST)
